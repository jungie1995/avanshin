...
import com.avanshin.clip.adapters.CastCrewAdapter;
import com.avanshin.clip.adapters.CommentsAdapter;
import com.avanshin.clip.adapters.EpisodeAdapter;
import com.avanshin.clip.adapters.DownloadAdapter;
import com.avanshin.clip.adapters.HomePageAdapter;
import com.avanshin.clip.adapters.ProgramAdapter;
import com.avanshin.clip.adapters.RelatedTvAdapter;
import com.avanshin.clip.adapters.EpisodeDownloadAdapter;
import com.avanshin.clip.adapters.ServerAdapter;
import com.avanshin.clip.database.DatabaseHelper;
import com.avanshin.clip.database.downlaod.DownloadViewModel;
import com.avanshin.clip.models.CastCrew;
import com.avanshin.clip.models.GetCommentsModel;
import com.avanshin.clip.models.CommonModels;
import com.avanshin.clip.models.EpiModel;
import com.avanshin.clip.models.PostCommentModel;
import com.avanshin.clip.models.Program;
import com.avanshin.clip.models.SubtitleModel;
import com.avanshin.clip.models.single_details.Cast;
import com.avanshin.clip.models.single_details.Director;
import com.avanshin.clip.models.single_details.DownloadLink;
import com.avanshin.clip.models.single_details.Episode;
import com.avanshin.clip.models.single_details.Genre;
import com.avanshin.clip.models.single_details.RelatedMovie;
import com.avanshin.clip.models.single_details.Season;
import com.avanshin.clip.models.single_details.SingleDetails;
import com.avanshin.clip.models.single_details.Subtitle;
import com.avanshin.clip.models.single_details.Video;
import com.avanshin.clip.models.single_details_tv.AdditionalMediaSource;
import com.avanshin.clip.models.single_details_tv.AllTvChannel;
import com.avanshin.clip.models.single_details_tv.ProgramGuide;
import com.avanshin.clip.models.single_details_tv.SingleDetailsTV;
import com.avanshin.clip.network.RetrofitClient;
import com.avanshin.clip.network.apis.CommentApi;
import com.avanshin.clip.network.apis.FavouriteApi;
import com.avanshin.clip.network.apis.ReportApi;
import com.avanshin.clip.network.apis.SingleDetailsApi;
import com.avanshin.clip.network.apis.SingleDetailsTVApi;
import com.avanshin.clip.network.apis.SubscriptionApi;
import com.avanshin.clip.network.model.ActiveStatus;
import com.avanshin.clip.network.model.config.AdsConfig;
import com.avanshin.clip.network.model.FavoriteModel;
import com.avanshin.clip.database.continueWatching.ContinueWatchingModel;
import com.avanshin.clip.database.continueWatching.ContinueWatchingViewModel;
import com.avanshin.clip.utils.HelperUtils;
import com.avanshin.clip.utils.PreferenceUtils;
import com.avanshin.clip.utils.RtlUtils;
import com.avanshin.clip.utils.TrackSelectionDialog;
import com.avanshin.clip.utils.ads.BannerAds;
import com.avanshin.clip.utils.Constants;
import com.avanshin.clip.utils.ads.PopUpAds;
import com.avanshin.clip.utils.ToastMsg;
import com.avanshin.clip.utils.Tools;
...
import static com.avanshin.clip.utils.Constants.CATEGORY_TYPE;
import static com.avanshin.clip.utils.Constants.CONTENT_ID;
import static com.avanshin.clip.utils.Constants.CONTENT_TITLE;
import static com.avanshin.clip.utils.Constants.IMAGE_URL;
import static com.avanshin.clip.utils.Constants.IS_FROM_CONTINUE_WATCHING;
import static com.avanshin.clip.utils.Constants.POSITION;
import static com.avanshin.clip.utils.Constants.SERVER_TYPE;
import static com.avanshin.clip.utils.Constants.STREAM_URL;
import static com.avanshin.clip.utils.Constants.YOUTUBE;
import static com.avanshin.clip.utils.Constants.YOUTUBE_LIVE;
